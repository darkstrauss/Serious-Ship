...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Serious Ship", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Serious Ship", null, { width: 1280, height: 768 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1280, height: 768 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 1280, 768, "null");
		#end
		#else
		create ();
		#end
